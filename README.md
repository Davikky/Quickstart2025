...
Makes sure you create a local virtual environment by using [uv](https://docs.astral.sh/uv/) or simply installing the _requirements.txt_ file.
...
* _Section 4_: Pure quantum approaches like [Quantum Neural Networks](./notebooks/4%20-%20Quantum%20Neural%20Networks.ipynb).s
